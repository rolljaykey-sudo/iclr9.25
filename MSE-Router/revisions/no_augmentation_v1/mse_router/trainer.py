...
class TrainingSettings:
    training_augmentation: str = "standard"
    ...
    def __post_init__(self) -> None:
        augmentation_config(self.training_augmentation)
...
class RouterTrainer:
    ...
    def _train_epoch(
        ...
        for step, cpu_batch in enumerate(loader, start=1):
            ...
            augmented, presence = prepare_training_batch(
                batch, self.settings.training_augmentation
            )
