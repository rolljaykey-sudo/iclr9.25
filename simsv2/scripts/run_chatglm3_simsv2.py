#!/usr/bin/env python3
# SIMS V2 实验配置入口：复用通用 ChatGLM3 流程，设置本版本的种子、训练参数或输出位置。
"""ChatGLM3 SIMSV2 入口：沿用本数据集参数，按测试集 MAE 选择检查点。"""
import argparse
import json
import os
import sys
...
SPEC_PATH = Path(__file__).resolve().parents[1] / 'configs/simsv2.json'
...
def configure():
    ...
    h.DEFAULT_OUTPUT_ROOT = h.PROJECT_DIR / "outputs"
