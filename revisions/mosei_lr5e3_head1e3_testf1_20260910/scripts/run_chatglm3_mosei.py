...
def configure():
    ...
    harness.DEFAULT_OUTPUT_ROOT = Path('/gpfs/work/cpt/jiachenhou23/mse router new conflict/outputs/glm_mosei_lr5e3_head1e3_testf1_20260910')
    ...
    class MoseiTrainingSettings(trainer.TrainingSettings):
        adapter_lr: float = 0.005
        head_router_lr: float = 0.001
