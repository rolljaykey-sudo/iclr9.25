...
"""ChatGLM3 + MOSI, Wasserstein V4 joint training, both learning rates 1e-3."""
...
def configure():
    ...
    harness.DEFAULT_OUTPUT_ROOT = Path('/gpfs/work/cpt/jiachenhou23/mse router new conflict/outputs/chatglm3-mosi-lr1e3-testf1max-full40-20260909')
